...
const steps: TutorialStep[] = [
    {
        ...
        content: "This is where the HTX real estate community comes together to share deals, strategies, and insights.",
        position: "center"
    },
    {
        targetId: "forum-left-sidebar",
        title: "Topics & Feeds",
        content: "Navigate through different real estate topics. From Creative Finance to Wholesaling, find the conversations that matter most to you.",
        position: "right"
    },
    {
        targetId: "forum-search-bar",
        title: "Find Your Answers",
        content: "Search through thousands of historical discussions, tags, and topics to find exactly what you're looking for.",
        position: "bottom"
    },
    {
        targetId: "forum-create-post",
        title: "Contribute to the Community",
        content: "Got a question or a deal to share? Start a new discussion here and get feedback from the pros.",
        position: "bottom"
    },
    {
        targetId: "forum-post-card-demo-1",
        title: "Real Estate Insights",
        content: "Posts show upvotes, comments, and tags. Let's take a closer look at this Subject-To success story.",
        position: "top"
    }
];

export default function ForumTutorial() {
    ...
    useEffect(() => {
        ...
        const hasSeenTutorial = localStorage.getItem("forum-tutorial-seen-v2");
        ...
        if (currentStoredStep !== null) {
            ...
            setStep(0);
            setIsVisible(true);
            localStorage.setItem("active-forum-tutorial-step-v2", "0");
        }
    }, []);
    ...
    const handleNext = () => {
        if (step < steps.length - 1) {
            ...
            setStep(nextStep);
            localStorage.setItem("active-forum-tutorial-step-v2", nextStep.toString());
        } else {
    ...
    const handleBack = () => {
        if (step > 0) {
            ...
            setStep(prevStep);
            localStorage.setItem("active-forum-tutorial-step-v2", prevStep.toString());
        }
    };

    const handleTransitionToDetail = () => {
        localStorage.setItem("active-forum-tutorial-step-v2", steps.length.toString());
        // Randomly select a demo post or just use demo-1
        window.location.assign("/app/forum/demo-1?demo=true");
    };
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between gap-4">
                            ...
                            >
                                {step === steps.length - 1 ? "Explore Post" : "Next Step"}
                            </motion.button>
                        </div>
                    </motion.div>
                </AnimatePresence>
