...
export default function VendorFilters({
  ...
  const [selectedWorkTypes, setSelectedWorkTypes] = useState<string[]>(parseListParam(searchParams.get("workType")));
  const [selectedMarkets, setSelectedMarkets] = useState<string[]>(parseListParam(searchParams.get("market")));
  ...
  const pushFilters = ({
    ...
    const path = queryString ? `/app/contractors?${queryString}` : "/app/contractors";
    router.push(path);
    router.refresh();
  };
  ...
  const renderFilterForm = (variant: "sidebar" | "drawer") => (
    <div className="space-y-6">
      <div>
        <p className="text-sm font-semibold text-zinc-900 dark:text-zinc-50">Type of work</p>
      ...
      <div className="flex items-center justify-between rounded-md border border-zinc-200 bg-white px-3 py-2 dark:border-zinc-800 dark:bg-zinc-950">
        <div>
          <p className="text-sm font-semibold text-zinc-900 dark:text-zinc-50">Only verified vendors</p>
          <p className="text-xs text-zinc-500 dark:text-zinc-400">
            Filter to teams we&apos;ve already vetted for investors.
          </p>
        </div>
        <input
          type="checkbox"
        ...
        <div className="hidden lg:block">
          <div className="rounded-xl border border-zinc-200 bg-white/70 p-5 shadow-sm ring-1 ring-inset ring-white/40 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/70 dark:ring-black/40">
            <div className="mb-4 flex items-center justify-between">
              <p className="text-base font-semibold text-zinc-900 dark:text-zinc-50">Filter vendors</p>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="relative min-w-[240px] flex-1">
            <input
              ...
              placeholder="Search by vendor name, trade, or service"
