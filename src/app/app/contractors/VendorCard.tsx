...
export default function VendorCard({ vendor }: VendorCardProps) {
  ...
  return (
    <div className="flex h-full flex-col rounded-xl border border-zinc-200 bg-white/60 p-5 shadow-sm ring-1 ring-inset ring-white/40 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/60 dark:ring-black/40">
