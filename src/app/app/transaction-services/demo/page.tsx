...
import TransactionServicesTutorial from "./TransactionServicesTutorial";
...
export default async function TransactionServicesDemoPage({
    searchParams,
}: {
    ...
    // Use only example services for Demo Mode
