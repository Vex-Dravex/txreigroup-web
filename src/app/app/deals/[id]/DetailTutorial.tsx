...
export default function DetailTutorial() {
    ...
    const steps: TutorialStep[] = [
        // Placeholder steps for Marketplace
        ...
        // Detail Steps (5-9)
        {
            ...
            content: "Now let's look at the full details of this wholesale deal. We'll show you the core specs and financing options.",
            position: "center"
        },
        {
            targetId: "detail-specs-bar",
            title: "Quick Specs",
            content: "Instantly see the property's core stats: beds, baths, square footage, and year built.",
            position: "bottom"
        },
        {
            targetId: "detail-transaction-card",
            title: "Financing & Entry",
            content: "This is the most important card! It shows the total Buyer Entry Cost, deal terms, and potential profit.",
            position: "left"
        },
        {
            targetId: "detail-inquiry-button",
            title: "Got Questions?",
            content: "Use the 'Start Full Inquiry' button to ask our Dispo team specific questions about the property.",
            position: "top"
        },
        {
            targetId: "detail-secure-button",
            title: "Ready to Move?",
            content: "Click 'Secure This Deal' to let our team know you're interested in purchasing. We'll contact you immediately.",
            position: "top"
        }
    ];

    useEffect(() => {
        // Only show if the tutorial is currently on a detail step
    ...
    const handleBack = () => {
        if (step > 5) {
            ...
            // Potentially allow going back to marketplace? 
            // For now, let's keep it simple and stay on step 5 or just stay on this page.
        }
    };
