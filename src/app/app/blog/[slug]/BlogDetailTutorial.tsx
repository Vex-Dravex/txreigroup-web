...
const steps: TutorialStep[] = [
    {
        ...
        content: "Every article is designed to give you actionable steps. Let's look at how we structure these insights.",
        position: "center"
    },
    {
        targetId: "blog-post-header",
        title: "Source of Truth",
        content: "Check the publication date and the expert author behind the article to ensure you're getting the most relevant data.",
        position: "bottom"
    },
    {
        targetId: "blog-post-content",
        title: "The Playbook",
        content: "We use high-impact imagery and clear typography to make complex strategies easy to digest and implement.",
        position: "top"
    },
    {
        title: "Coming Soon",
        content: "The full Blog & Insights center is coming soon. Stay tuned for more expert tactics and market deep-dives.",
        position: "center"
    }
];

export default function BlogDetailTutorial() {
    ...
    useEffect(() => {
        ...
        // This tutorial only starts if we're on step after home tour
        if (currentStoredStep === "3") {
            setStep(0);
            setIsVisible(true);
        }
    }, []);
    ...
    return (
        <div className="fixed inset-0 z-[9999] pointer-events-none overflow-hidden">
            <svg className="absolute inset-0 w-full h-full pointer-events-auto">
                <defs>
                    <mask id="blog-detail-spotlight-mask">
                ...
                <rect
                    ...
                    mask="url(#blog-detail-spotlight-mask)"
                    onClick={handleSkip}
